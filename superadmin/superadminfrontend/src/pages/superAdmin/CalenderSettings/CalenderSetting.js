...
const CalenderSetting = () => {
  ...
  const updateBranchDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/updateBranchCalenderSetting/${branch.name}`,
        upData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getHolidayList = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/getHolidays/${branch.name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const addHolidays = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/addBlockDays",
        holidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const updateHolidetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/updateHolidays/${selected.holiday_id}`,
        upHolidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteHoliday = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://dentalguru-superadmin.vimubds5.a2hosted.com/api/v1/super-admin/deleteHolidays/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
