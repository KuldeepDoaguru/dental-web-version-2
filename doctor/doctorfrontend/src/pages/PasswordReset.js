...
const PasswordReset = () => {
  ...
  const sendOtp = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/sendOtp",
        {
          email,
        }
      );
  ...
  const verifyOtpAdmin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/verifyOtp",
        {
          email,
          otp,
        }
  ...
  const changePassword = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/resetPassword",
        {
          email,
