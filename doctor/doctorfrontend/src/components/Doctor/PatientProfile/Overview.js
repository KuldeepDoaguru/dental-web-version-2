...
const Overview = () => {
  ...
  const getAppointDetailsPat = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getAllAppointmentByPatientId/${uhid}/${branch}`,
        {
          headers: {
  ...
  const fetchLatestDentalPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getExaminationViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestPrescriptionPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getPrescriptionViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestBillPatientData = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/get-patientBill-data/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const onGoingTreat = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/onGoingTreat/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
