...
const BookSittingAppointment = ({
  ...
  const getBranchDetail = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/get-branch-detail/${branch_name}`,
        {
          headers: {
  ...
  const getBranchHolidays = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/get-branch-holidays/${branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getDoctorsWithLeave = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/get-doctors-with-leave/${branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getDoctorAppoint = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getAppointmentsViaDocId/${branch_name}/${employee_ID}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleBookSittingAppointment = async (e) => {
    ...
    if (isSlotAvailable) {
      ...
      try {
        const response = await axios.post(
          "https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/bookSittingAppointment",
          data,
          {
            headers: {
              "Content-Type": "application/json",
