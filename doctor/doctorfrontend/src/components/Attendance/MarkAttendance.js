  ...
  const getTodayAttendance = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getTodayAttendance/${branch_name}/${employee_ID}/${date}`,
        {
          headers: {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/markAttendanceLogin",
        {
          branch_name,
          employee_ID,
          employee_name,
  ...
  const handleLogout = async () => {
    ...
    try {
      const response = await axios.put(
        "https://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/markAttendanceLogout",
        {
          branch_name,
          employee_ID,
          employee_name,
