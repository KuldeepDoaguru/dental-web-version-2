  ...
  const getTodayAttendance = async () => {
    try {
      const response = await axios.get(
        `http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/getTodayAttendance/${branch_name}/${employee_ID}/${date}`,
        {
          headers: {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post(
        "http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/markAttendanceLogin",
        {
          branch_name,
          employee_ID,
          employee_name,
  ...
  const handleLogout = async () => {
    ...
    try {
      const response = await axios.put(
        "http://dentalguru-doctor.vimubds5.a2hosted.com/api/doctor/markAttendanceLogout",
        {
          branch_name,
          employee_ID,
          employee_name,
