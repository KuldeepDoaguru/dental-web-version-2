...
const Overview = () => {
  ...
  const getPrescriptionDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPrescriptionViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getBillsViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getExaminationDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getExaminationViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getAppointDetailsPat = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getAllAppointmentByPatientId/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
