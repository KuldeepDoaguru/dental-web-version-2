...
const {
  ...
  sendWhatsapp,
  sendSMS,
} = require("../controllers/admintreatController.js");
...
router.get(
  "/getPatientBillByBranchAndId/:branch/:uhid",
  authenticate,
  getPatientBillByBranchAndId
);
router.get(
...
router.get("/getSittingBill/:branch", getSittingBill);
router.get("/getLabDetails/:tpid", getLabDetails);
router.get(
