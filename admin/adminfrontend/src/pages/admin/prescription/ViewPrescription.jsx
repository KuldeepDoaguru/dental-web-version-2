...
const ViewPrescription = () => {
  ...
  const getTreatDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatmentDataList/${tpid}/${user.branch_name}`,
        {
          headers: {
  ...
  const getTreatPrescriptionByAppointId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatPrescriptionByAppointIdList/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getEmployeeData = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getEmployeeDetails/${user.branch_name}/${getPatientData[0]?.doctor_id}`,
        {
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: `Bearer ${user.token}`,
