  ...
  const addTreatments = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/addTreatment",
        treatData,
        {
          headers: {
  ...
  const getTreatmentList = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatmentList",
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const updateTreatmentDetails = async (e, id) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/updateTreatmentDetails/${id}`,
        treatData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteTreatment = async (id) => {
    try {
      const response = await axios.delete(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/deleteTreatment/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
