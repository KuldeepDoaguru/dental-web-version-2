...
const LabTest = () => {
  ...
  const getLabtestDetails = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getLabTest",
        {
          headers: {
  ...
  const updateLabData = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/updateLabTestDetails/${selectedItem.lab_tid}`,
        upLabTestField,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getListLabDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getLabList/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
    ...
    try {
      ...
      if (isConfirmed) {
        const response = await axios.delete(
          `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/labTestDelete/${id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${user.token}`,
  ...
  const insertLabTestClinic = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/addLabTest",
        addLabTestField,
        {
          headers: {
            "Content-Type": "application/json",
