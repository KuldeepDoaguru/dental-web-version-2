...
const ViewSittingBill = () => {
  const { tpid, sitting, treatment, appoint_id, uhid } = useParams();
  console.log(uhid);
  ...
  const getBranchDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getBranchDetailsByBranch/${user.branch_name}`,
        {
          headers: {
  ...
  const getPatientDetail = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getPatientDataByBranchAndId/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getSittingBillbyId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getSittingBillbyId/${user.branch_name}/${sitting}/${tpid}/${treatment}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getDoctorDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getEmployeeDetails/${user.branch_name}/${sittingBill[0]?.doctor_id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getExamineDetails = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getDentalDataByTpid/${tpid}/${user.branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
...
export default ViewSittingBill;
