...
const PatientBillsByTpid = () => {
  ...
  const getBranchDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getBranchDetailsByBranch/${branch}`,
        {
          headers: {
  ...
  const getPatientDetail = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getAppointmentsWithPatientDetailsById/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getExaminDetail = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getDentalDataByTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getTreatDetail = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatmentDetailsViaTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getTreatPrescriptionByAppointId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatPrescriptionByTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getTreatmentSuggestAppointId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getTreatSuggestViaTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/billDetailsViaTpid/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const getDoctorDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getEmployeeDetails/${branch}/${getTreatData[0]?.dir_rec_doctor_id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const sendPrescriptionMail = async () => {
    try {
      ...
      const response = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/prescriptionOnMail",
        formData,
        {
          headers: {
  ...
  const sendPrescriptionWhatsapp = async () => {
    try {
      ...
      const res = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/sendWhatsapp",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const billDetailsSms = async () => {
    try {
      const { data } = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/sendSMS",
        formDetails,
        {
          headers: {
            "Content-Type": "application/json",
