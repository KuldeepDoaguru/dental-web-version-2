  ...
  const getAttendDetails = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getAttendanceDetails/${branch}`,
        {
          headers: {
  ...
  const downloadAttendData = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/downloadAttendanceReportByTime/${branch}`,
