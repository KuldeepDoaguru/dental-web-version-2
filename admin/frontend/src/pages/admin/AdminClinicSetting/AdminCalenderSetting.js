...
const CalenderSetting = () => {
  ...
  const updateBranchDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/updateBranchCalenderSetting/${branch}`,
        upData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getHolidayList = async () => {
    try {
      setLoading(true);
      const { data } = await axios.get(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/getHolidays/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
  ...
  const addHolidays = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/addBlockDays",
        holidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const updateHolidetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/updateHolidays/${selected.holiday_id}`,
        upHolidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteHoliday = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://dentalguru-admin.vimubds5.a2hosted.com/api/v1/admin/deleteHolidays/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${user.token}`,
    ...
    <>
      <Container>
        ...
        <div className="main">
          ...
          >
            <div className="popup">
              <h4 className="text-center">Edit Block Day</h4>
